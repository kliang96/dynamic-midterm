...
function nextQuestion() {
    ...
    // } else {
    document.querySelector(".quiz_question_number").innerText = data.question1[data.number].questionNo;
    document.querySelector(".quiz_question_question").innerText = `data.question${count}`[data.number].question;
